...
public abstract class Tower {
    ...
    abstract public void Shoot(List<sample.Enemy> enemyList);
    ...
    public void setY_pos(double y_pos) { this.y_pos = y_pos; }
    public void setX_pos(double x_pos) { this.x_pos = x_pos; }
    public int getRange() {
        return range;
    }
